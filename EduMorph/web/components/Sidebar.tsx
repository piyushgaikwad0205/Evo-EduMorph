...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      <div
        className={`
          bg-slate-50/80 dark:bg-slate-800/80 h-full border-r border-slate-200 dark:border-slate-700 flex flex-col transition-all duration-300 ease-in-out overflow-hidden
          ${isMobileMenuOpen ? "mobile-sidebar-drawer open" : "mobile-sidebar-drawer closed md:mobile-sidebar-drawer-none"}
          md:relative md:flex-shrink-0 md:transform-none
        `}
      ...
      >
        ...
        {/* Navigation */}
        <nav
          className={`flex-1 overflow-y-auto py-2 space-y-4 transition-all duration-300 mobile-scroll ${sidebarCollapsed ? "px-2" : "px-2"
            }`}
        >
                ...
                {group.items.map((item) => {
                  ...
                  return (
                    ...
                    >
                      <Link
                        href={item.href}
                        className={`touch-target flex items-center rounded-md border transition-all duration-200 ${sidebarCollapsed
                            ? "justify-center p-2"
                      ...
                      >
                        ...
                        {/* Drag handle - only show when expanded and hovering, now on right - hidden on mobile */}
                        <div
                          className={`flex-shrink-0 transition-all duration-300 hidden md:block ${sidebarCollapsed
        ...
        >
          <div className="relative">
            <Link
              href="/settings"
              className={`touch-target flex items-center rounded-md text-sm transition-all duration-200 ${sidebarCollapsed
                  ? "justify-center p-2"
                  : "gap-2.5 pl-2 pr-1.5 py-2"
                } ${pathname === "/settings"
